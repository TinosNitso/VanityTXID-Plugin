...
Next version should have a QCheckBox lock on the Script input. There's an issue when vanitizing a plain text file like .cpp or .py, because appending a nonce is adding characters to the document. Before vanitizing such files, they should have a message at the end.
