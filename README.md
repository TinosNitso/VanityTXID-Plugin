...
main.cpp & Icon.rc are compiled together using -O3 -march=corei7-avx with the gcc compiler. The three .dll libraries are extracted directly from 'codeblocks-20.03-32bit-mingw-32bit-nosetup.zip'. Linux & macOS compiling don't use Icon.rc. I've now included the Windows project file with example arguments so others can build & run immediately. The screenshot for v1.3.0 involved nonce '0400000000b3479b', where '04' corresponds to the 5th thread. v1.3.0 SHA256 Checksum: 19428b63d42b1fe33e89af5f678dad88360c017331fe6ff5bea8cb1f96bdb49c
