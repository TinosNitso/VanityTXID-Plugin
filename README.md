...
I've been working on an update I'll release today. The biggest issue is the bug where v1.0.1 only mines the first input, due to a higher order nonce positioning bug (uint8_t C++ problem).
